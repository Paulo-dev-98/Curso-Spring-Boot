INSERT INTO `person` (`id`, `address`, `first_name`, `gender`, `last_name`) VALUES
	...
	(7, 'Patos de Minas - Minas Gerais - Brasil', 'Andre', 'Male', 'Paulo'),
	(8, 'Patos de Minas - Minas Gerais - Brasil', 'marlom', 'Male', 'Paulo'),
	(9, 'Patos de Minas - Minas Gerais - Brasil', 'mar', 'Male', 'Paulo');